export const ru = {
  ...
  'eventNew.announce.label': 'Анонс в канал',
  'eventNew.announce.hint': 'Пост с кнопкой «Записаться» уйдёт в «{channel}»',
  'eventNew.announce.failed': 'Событие создано, но анонс в канал не ушёл',
  ...
  'eventMenu.announce': 'Анонсировать в канал',
  'eventMenu.announceAgain': 'Анонсировать повторно',
  'eventMenu.announcing': 'Публикуем...',
  'eventMenu.announceDone': 'Анонс опубликован в канале',
  ...
  'teamSettings.channel.title': 'Канал анонсов',
  'teamSettings.channel.notBound': 'Канал не привязан',
  'teamSettings.channel.notBoundHint': 'Анонсы событий уходят только в личные сообщения от бота',
  'teamSettings.channel.boundNoTitle': 'Канал привязан',
  ...
  'teamSettings.channel.step1':
    'Добавь {bot} администратором своего Telegram-канала с правом «Публикация сообщений».',
  'teamSettings.channel.step2': 'Перешли {bot} в личку любой пост из этого канала.',
  'teamSettings.channel.step3': 'Бот ответит, что канал привязан, — статус здесь обновится.',
  'teamSettings.channel.unbind': 'Отвязать канал',
  'teamSettings.channel.unbindError': 'Не получилось отвязать канал',
