export const ru = {
  ...
  // Quick-actions организатора на главной (v0.6, передизайн от 2026-06-08).
  // На главной показываются две плитки в строке: «Создать событие» (всегда
  // активна) и «Заявки» (со счётчиком pending, если есть). Остальные слоты
  // (markPayments / recordResult) оставлены в ключах на ближайшее расширение
  // — UI их не использует, но текст уже согласован.
  'home.actions.title': 'Быстрые действия',
  ...
  'eventNew.announce.label': 'Анонс в чат команды',
  'eventNew.announce.hint': 'Пост с кнопкой «Записаться» уйдёт в «{channel}»',
  'eventNew.announce.failed': 'Событие создано, но анонс в чат не ушёл',
  ...
  'eventMenu.announce': 'Анонсировать в чат',
  'eventMenu.announceAgain': 'Анонсировать повторно',
  'eventMenu.announcing': 'Публикуем...',
  'eventMenu.announceDone': 'Анонс опубликован',
  'eventMenu.announceError': 'Не получилось опубликовать анонс',
  ...
  'teamSettings.sectionImages.section.announce_training': 'Анонс тренировки',
  'teamSettings.sectionImages.section.announce_game': 'Анонс игры',
  ...
  'teamSettings.channel.title': 'Чат анонсов',
  'teamSettings.channel.notBound': 'Чат не привязан',
  'teamSettings.channel.notBoundHint': 'Анонсы событий уходят только в личные сообщения от бота',
  'teamSettings.channel.boundNoTitle': 'Чат привязан',
  'teamSettings.channel.boundHint': 'Сюда публикуются анонсы тренировок и игр',
  'teamSettings.channel.botFallback': 'бота',
  'teamSettings.channel.step1':
    'Добавь {bot} в группу команды в Telegram. Если ты админ этой группы — чат привяжется сам, бот напишет об этом.',
  'teamSettings.channel.step2':
    'Не привязался или нужна другая группа? Отправь в группе команду {cmd}',
  'teamSettings.channel.step3':
    'В группе с темами отправь команду в нужной теме — анонсы будут приходить туда.',
  'teamSettings.channel.channelNote':
    'Канал вместо группы: сделай {bot} администратором с правом «Публикация сообщений» и перешли ему в личку любой пост из канала.',
  'teamSettings.channel.unbind': 'Отвязать чат',
  'teamSettings.channel.unbindError': 'Не получилось отвязать чат',
