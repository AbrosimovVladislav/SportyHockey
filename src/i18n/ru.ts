export const ru = {
  ...
  'myProfile.contacts.emailTitle': 'E-mail',
  'myProfile.contacts.usernameTitle': 'Telegram',
  'myProfile.contacts.phonePlaceholder': 'Указать телефон',
  'myProfile.contacts.emailPlaceholder': 'Указать e-mail',
  'myProfile.contacts.usernamePlaceholder': 'Указать Telegram-ник',
  'myProfile.contacts.visibilityHint': 'Контакт виден участникам команды',
  ...
  'myProfile.section.card.title': 'Моя карточка',
  'myProfile.section.card.subtitle': 'Имя, фото, контакты, амплуа',
