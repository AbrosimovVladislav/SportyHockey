export const ru = {
  ...
  'eventNew.sections.repeat': 'Повтор',
  'eventNew.repeat.label': 'Сколько тренировок',
  'eventNew.repeat.hint': 'Каждую неделю в этот же день и время',
  'eventNew.repeat.less': 'Меньше',
  'eventNew.repeat.more': 'Больше',
  'eventNew.repeat.dates': 'Создадим: {dates}. Анонс в группу уйдёт только о ближайшей.',
  'eventNew.submitSeries': 'Создать тренировки: {count}',
  ...
  'eventNew.announce.label': 'Анонс в группу команды',
  'eventNew.announce.hint': 'Пост с кнопкой «Записаться» уйдёт в «{channel}»',
  'eventNew.announce.failed': 'Событие создано, но анонс в группу не ушёл',
  ...
  // Карточка «Анонс в группу» на /events/[id] (организатор)
  'eventAnnounce.title': 'Анонс в группу',
  'eventAnnounce.ready': 'Пост с фото и кнопкой «Записаться» уйдёт в «{group}»',
  'eventAnnounce.sentAt': 'Отправлен {when} в «{group}»',
  'eventAnnounce.send': 'Отправить анонс',
  'eventAnnounce.sendAgain': 'Отправить ещё раз',
