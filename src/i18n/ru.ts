export const ru = {
  ...
  'eventNew.fields.details.placeholder1': 'Например: Игра vs Северные Волки',
  'eventNew.fields.details.placeholder2': 'Что важно знать игрокам',
  'eventNew.fields.venue.placeholder': 'Выберите площадку',
  'eventNew.cost.auto': 'Заполняется автоматически',
  'eventNew.cost.placeholder': '—',
  'eventNew.submit': 'Создать событие',
  'eventNew.submitting': 'Создаём...',
  'eventNew.sheet.duration.title': 'Длительность',
  'eventNew.sheet.venue.title': 'Выберите площадку',
  'eventNew.duration.60': '1 час',
  'eventNew.duration.90': '1,5 часа',
  'eventNew.duration.120': '2 часа',
  'eventNew.duration.150': '2,5 часа',
  'eventNew.duration.180': '3 часа',
