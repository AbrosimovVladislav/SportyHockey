...
// игра», «Команда».
//
// Высота карточки **фиксирована по самому длинному табу** (топ-5 с 5
// игроками, ~290 px) → `min-height: 320 px` на body, чтобы переключение
// между табами не двигало layout страницы. При коротких табах внизу
// остаётся пустое пространство — это намеренно (стабильность UI важнее
// плотности).
